...
function ListRoom() {
  ...
  return (
    <div>
      ...
      {rooms.length === 0 ? (
        <div className=' mt-10 flex flex-col items-center justify-center py-14 px-6 text-gray-500 border border-dashed rounded-xl bg-gray-50 gap-4'>
          <p className='text-xl font-semibold text-gray-800'>
            No Rooms Available
          </p>
          <p className="text-sm text-gray-500 text-center max-w-xs">
            You haven’t added . Start by creating a new room to make it available for booking.
          </p>
        </div>
      ) : (<>
